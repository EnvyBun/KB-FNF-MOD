...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
            ...
            case 'kanye-bear':
                tex = Paths.getSparrowAtlas('kb/KB_assets');
                frames = tex;
                animation.addByPrefix('idle', 'KB Idle', 24);
                animation.addByPrefix('singUP', 'KB up', 24);
                animation.addByPrefix('singRIGHT', 'KB Right', 24);
                animation.addByPrefix('singDOWN', 'KB Down', 24);
                animation.addByPrefix('singLEFT', 'KB Left', 24);

                addOffset('idle');
                addOffset("singUP", 78, 125);
                addOffset("singRIGHT", 60, 12);
                addOffset("singLEFT", -2, 1);
                addOffset("singDOWN", 0, -68);
