...
HX_LOCAL_STACK_FRAME(_hx_pos_4937ee5e54fcaf42_574_boot,"__ASSET__flixel_images_logo_default_png","boot",0x6c1f3055,"__ASSET__flixel_images_logo_default_png.boot","ManifestResources.hx",574,0xf77aa668)
...
HXLINE( 377)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName),null());
            	}
...
bool __ASSET__flixel_images_logo_default_png_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x33f052f7) {
		...
		return inClassId==(int)0x5fdb8f87;
	}
}
...
::hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __ASSET__flixel_images_logo_default_png_obj::__new( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type) {
...
::hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __ASSET__flixel_images_logo_default_png_obj::__alloc(::hx::Ctx *_hx_ctx, ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type) {
...
static ::hx::StaticInfo __ASSET__flixel_images_logo_default_png_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &__ASSET__flixel_images_logo_default_png_obj::resourceName,HX_("resourceName",39,7a,62,90)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	__ASSET__flixel_images_logo_default_png_obj _hx_dummy;
	__ASSET__flixel_images_logo_default_png_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("__ASSET__flixel_images_logo_default_png",2b,27,16,9e);
...
{
{
            	HX_STACKFRAME(&_hx_pos_4937ee5e54fcaf42_574_boot)
HXDLIN( 574)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_logo_default_png",5d,c4,77,3f);
            	}
}
