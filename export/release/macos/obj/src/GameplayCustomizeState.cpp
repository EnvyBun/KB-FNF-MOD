...
HXLINE(  48)		::flixel::FlxG_obj::cameras->add(this->camHUD).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 150)		{
HXLINE( 150)			 ::flixel::FlxCamera _g = ::flixel::FlxG_obj::camera;
HXDLIN( 150)			_g->set_zoom((_g->zoom + ((Float)0.015)));
            		}
HXLINE( 151)		{
HXLINE( 151)			 ::flixel::FlxCamera _g1 = this->camHUD;
HXDLIN( 151)			_g1->set_zoom((_g1->zoom + ((Float)0.010)));
            		}
...
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::FlxSprite _g = babyArrow;
HXDLIN( 176)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(0) ))));
            				}
...
HXLINE( 181)				{
HXLINE( 181)					 ::flixel::FlxSprite _g = babyArrow;
HXDLIN( 181)					_g->set_x((_g->x + ::Note_obj::swagWidth));
            				}
...
HXLINE( 186)				{
HXLINE( 186)					 ::flixel::FlxSprite _g = babyArrow;
HXDLIN( 186)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(2) ))));
            				}
...
HXLINE( 191)				{
HXLINE( 191)					 ::flixel::FlxSprite _g = babyArrow;
HXDLIN( 191)					_g->set_x((_g->x + (::Note_obj::swagWidth * ( (Float)(3) ))));
            				}
...
HXLINE( 207)			{
HXLINE( 207)				 ::flixel::FlxSprite _g1 = babyArrow;
HXDLIN( 207)				_g1->set_x((_g1->x + 50));
            			}
HXLINE( 208)			{
HXLINE( 208)				 ::flixel::FlxSprite _g2 = babyArrow;
HXDLIN( 208)				_g2->set_x((_g2->x + ((( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) )) * ( (Float)(player) ))));
            			}
