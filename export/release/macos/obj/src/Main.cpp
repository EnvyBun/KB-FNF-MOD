...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_48_init,"Main","init",0xea732345,"Main.init","Main.hx",48,0x087e5c05)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_91_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",91,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_96_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",96,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_101_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",101,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_106_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",106,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_111_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",111,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_30_main,"Main","main",0xed0e206e,"Main.main","Main.hx",30,0x087e5c05)
...
HXLINE(  37)		if (::hx::IsNotNull( this->stage )) {
HXLINE(  39)			this->init(null());
            		}
            		else {
HXLINE(  43)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_48_init)
HXLINE(  49)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  51)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
...
HXLINE(  59)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  60)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  62)		if ((this->zoom == -1)) {
HXLINE(  64)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  65)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  66)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  67)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  68)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  72)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  75)		this->game =  ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen);
HXLINE(  77)		this->addChild(this->game);
HXLINE(  80)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  81)		this->addChild(this->fpsCounter);
HXLINE(  82)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_91_toggleFPS)
HXDLIN(  91)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_96_changeFPSColor)
HXDLIN(  96)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_101_setFPSCap)
HXDLIN( 101)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_106_getFPSCap)
HXDLIN( 106)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_111_getFPS)
HXDLIN( 111)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_30_main)
HXDLIN(  30)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  30)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
