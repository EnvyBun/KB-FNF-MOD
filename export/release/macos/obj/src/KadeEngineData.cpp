...
HXLINE(  23)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic) )) {
HXLINE(  24)			::flixel::FlxG_obj::save->data->__SetField(HX_("offset",93,97,3f,60),0,::hx::paccDynamic);
            		}
HXLINE(  26)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic) )) {
HXLINE(  27)			::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),false,::hx::paccDynamic);
            		}
HXLINE(  29)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic) )) {
HXLINE(  30)			::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),false,::hx::paccDynamic);
            		}
HXLINE(  32)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("changedHit",bf,5d,c0,31),::hx::paccDynamic) )) {
HXLINE(  34)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHitX",b9,a9,91,56),-1,::hx::paccDynamic);
HXLINE(  35)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHitY",ba,a9,91,56),-1,::hx::paccDynamic);
HXLINE(  36)			::flixel::FlxG_obj::save->data->__SetField(HX_("changedHit",bf,5d,c0,31),false,::hx::paccDynamic);
            		}
HXLINE(  39)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsRain",dd,e5,17,c7),::hx::paccDynamic) )) {
HXLINE(  40)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsRain",dd,e5,17,c7),false,::hx::paccDynamic);
            		}
HXLINE(  42)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic) )) {
HXLINE(  43)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsCap",a9,7b,7e,91),120,::hx::paccDynamic);
            		}
HXLINE(  45)		bool _hx_tmp;
HXDLIN(  45)		if (!(::hx::IsGreater( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),285 ))) {
HXLINE(  45)			_hx_tmp = ::hx::IsLess( ::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic),60 );
            		}
            		else {
HXLINE(  45)			_hx_tmp = true;
            		}
HXDLIN(  45)		if (_hx_tmp) {
HXLINE(  46)			::flixel::FlxG_obj::save->data->__SetField(HX_("fpsCap",a9,7b,7e,91),120,::hx::paccDynamic);
            		}
HXLINE(  48)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic) )) {
HXLINE(  49)			::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeed",3a,e0,46,cb),1,::hx::paccDynamic);
            		}
HXLINE(  51)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic) )) {
HXLINE(  52)			::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),false,::hx::paccDynamic);
            		}
HXLINE(  54)		if (::hx::IsNull( ::flixel::FlxG_obj::save->data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic) )) {
HXLINE(  55)			::flixel::FlxG_obj::save->data->__SetField(HX_("frames",a6,af,85,ac),10,::hx::paccDynamic);
            		}
HXLINE(  57)		::Conductor_obj::recalculateTimings();
HXLINE(  59)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->setFPSCap(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("fpsCap",a9,7b,7e,91),::hx::paccDynamic)) ));
            	}
