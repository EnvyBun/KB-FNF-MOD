...
HX_DEFINE_STACK_FRAME(_hx_pos_2e74c672ca03138f_24_new,"openfl.filters.ShaderFilter","new",0xe9b87900,"openfl.filters.ShaderFilter.new","openfl/filters/ShaderFilter.hx",24,0x3faaafae)
HX_LOCAL_STACK_FRAME(_hx_pos_2e74c672ca03138f_33_clone,"openfl.filters.ShaderFilter","clone",0xd2bb23fd,"openfl.filters.ShaderFilter.clone","openfl/filters/ShaderFilter.hx",33,0x3faaafae)
HX_LOCAL_STACK_FRAME(_hx_pos_2e74c672ca03138f_44_invalidate,"openfl.filters.ShaderFilter","invalidate",0x2cb1c4db,"openfl.filters.ShaderFilter.invalidate","openfl/filters/ShaderFilter.hx",44,0x3faaafae)
HX_LOCAL_STACK_FRAME(_hx_pos_2e74c672ca03138f_48___initShader,"openfl.filters.ShaderFilter","__initShader",0x314ad8d5,"openfl.filters.ShaderFilter.__initShader","openfl/filters/ShaderFilter.hx",48,0x3faaafae)
HX_LOCAL_STACK_FRAME(_hx_pos_2e74c672ca03138f_13_boot,"openfl.filters.ShaderFilter","boot",0x8fca6792,"openfl.filters.ShaderFilter.boot","openfl/filters/ShaderFilter.hx",13,0x3faaafae)
namespace openfl{
namespace filters{

void ShaderFilter_obj::__construct( ::openfl::display::Shader shader){
            	HX_STACKFRAME(&_hx_pos_2e74c672ca03138f_24_new)
HXLINE(  25)		super::__construct();
HXLINE(  27)		this->shader = shader;
HXLINE(  29)		this->_hx___numShaderPasses = 1;
            	}
...
bool ShaderFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter ShaderFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_2e74c672ca03138f_33_clone)
HXLINE(  34)		 ::openfl::filters::ShaderFilter filter =  ::openfl::filters::ShaderFilter_obj::__alloc( HX_CTX ,this->shader);
HXLINE(  35)		filter->bottomExtension = this->bottomExtension;
HXLINE(  36)		filter->leftExtension = this->leftExtension;
HXLINE(  37)		filter->rightExtension = this->rightExtension;
HXLINE(  38)		filter->topExtension = this->topExtension;
HXLINE(  39)		return filter;
            	}


void ShaderFilter_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_2e74c672ca03138f_44_invalidate)
HXDLIN(  44)		this->_hx___renderDirty = true;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ShaderFilter_obj,invalidate,(void))
 ...
 ::openfl::display::Shader ShaderFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_STACKFRAME(&_hx_pos_2e74c672ca03138f_48___initShader)
HXLINE(  49)		this->_hx___shaderBlendMode = this->blendMode;
HXLINE(  50)		return this->shader;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_2e74c672ca03138f_13_boot)
