...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_567_removeKeyboard,"Controls","removeKeyboard",0xd2dac3e3,"Controls.removeKeyboard","Controls.hx",567,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_580_addGamepad,"Controls","addGamepad",0xa2c68b58,"Controls.addGamepad","Controls.hx",580,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_593_addGamepadLiteral,"Controls","addGamepadLiteral",0x50b4e0f7,"Controls.addGamepadLiteral","Controls.hx",593,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_606_removeGamepad,"Controls","removeGamepad",0xfdf294e5,"Controls.removeGamepad","Controls.hx",606,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_624_addDefaultGamepad,"Controls","addDefaultGamepad",0xaa5e6409,"Controls.addDefaultGamepad","Controls.hx",624,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_658_bindButtons,"Controls","bindButtons",0x94dee42c,"Controls.bindButtons","Controls.hx",658,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_671_unbindButtons,"Controls","unbindButtons",0x83d33473,"Controls.unbindButtons","Controls.hx",671,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_695_getInputsFor,"Controls","getInputsFor",0xa3571ac2,"Controls.getInputsFor","Controls.hx",695,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_719_removeDevice,"Controls","removeDevice",0x4c1b5cd2,"Controls.removeDevice","Controls.hx",719,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_679_addButtons,"Controls","addButtons",0xe3b5fcf8,"Controls.addButtons","Controls.hx",679,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_684_removeButtons,"Controls","removeButtons",0x3ee20685,"Controls.removeButtons","Controls.hx",684,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_730_isDevice,"Controls","isDevice",0xe09e10f8,"Controls.isDevice","Controls.hx",730,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_739_isGamepad,"Controls","isGamepad",0x5bcd81ff,"Controls.isGamepad","Controls.hx",739,0x0ab041e8)
...
HXLINE( 498)		switch((int)(scheme->_hx_getIndex())){
            			case (int)0: {
HXLINE( 501)				{
HXLINE( 501)					::Array< int > keys = ::Array_obj< int >::fromData( _hx_array_data_116e4296_443,2);
...
HXLINE( 502)				{
HXLINE( 502)					::Array< int > keys1 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_444,2);
...
HXLINE( 503)				{
HXLINE( 503)					::Array< int > keys2 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_445,2);
...
HXLINE( 504)				{
HXLINE( 504)					::Array< int > keys3 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_446,2);
...
HXLINE( 505)				{
HXLINE( 505)					::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_447,3);
...
HXLINE( 506)				{
HXLINE( 506)					::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_448,2);
...
HXLINE( 507)				{
HXLINE( 507)					::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_449,3);
...
HXLINE( 508)				{
HXLINE( 508)					::Array< int > keys7 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_450,1);
...
HXDLIN( 508)								action->addKey(key,state);
            			...
            			break;
            			case (int)1: {
HXLINE( 517)				if (scheme->_hx_getBool(0)) {
HXLINE( 510)					{
HXLINE( 510)						::Array< int > keys = ::Array_obj< int >::fromData( _hx_array_data_116e4296_451,2);
...
HXLINE( 511)					{
HXLINE( 511)						::Array< int > keys1 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_452,2);
...
HXLINE( 512)					{
HXLINE( 512)						::Array< int > keys2 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_453,2);
...
HXLINE( 513)					{
HXLINE( 513)						::Array< int > keys3 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_454,2);
...
HXLINE( 514)					{
HXLINE( 514)						::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_455,4);
...
HXLINE( 515)					{
HXLINE( 515)						::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_456,2);
...
HXLINE( 516)					{
HXLINE( 516)						::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_457,1);
HXDLIN( 516)						switch((int)(::Control_obj::RESET_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 516)								{
...
HXLINE( 518)					{
HXLINE( 518)						::Array< int > keys = ::Array_obj< int >::fromData( _hx_array_data_116e4296_458,1);
HXDLIN( 518)						switch((int)(::Control_obj::UP_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 518)								{
HXLINE( 518)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 518)									int state = 1;
HXDLIN( 518)									int _g = 0;
HXDLIN( 518)									while((_g < keys->length)){
HXLINE( 518)										int key = keys->__get(_g);
HXDLIN( 518)										_g = (_g + 1);
...
HXDLIN( 518)									while((_g1 < keys->length)){
HXLINE( 518)										int key = keys->__get(_g1);
...
HXDLIN( 518)									while((_g2 < keys->length)){
HXLINE( 518)										int key = keys->__get(_g2);
...
HXLINE( 519)					{
HXLINE( 519)						::Array< int > keys1 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_459,1);
HXDLIN( 519)						switch((int)(::Control_obj::DOWN_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 519)								{
HXLINE( 519)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 519)									int state = 1;
HXDLIN( 519)									int _g = 0;
HXDLIN( 519)									while((_g < keys1->length)){
HXLINE( 519)										int key = keys1->__get(_g);
HXDLIN( 519)										_g = (_g + 1);
...
HXDLIN( 519)									while((_g1 < keys1->length)){
HXLINE( 519)										int key = keys1->__get(_g1);
...
HXDLIN( 519)									while((_g2 < keys1->length)){
HXLINE( 519)										int key = keys1->__get(_g2);
...
HXLINE( 520)					{
HXLINE( 520)						::Array< int > keys2 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_460,1);
HXDLIN( 520)						switch((int)(::Control_obj::LEFT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 520)								{
HXLINE( 520)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 520)									int state = 1;
HXDLIN( 520)									int _g = 0;
HXDLIN( 520)									while((_g < keys2->length)){
HXLINE( 520)										int key = keys2->__get(_g);
HXDLIN( 520)										_g = (_g + 1);
...
HXDLIN( 520)									while((_g1 < keys2->length)){
HXLINE( 520)										int key = keys2->__get(_g1);
...
HXDLIN( 520)									while((_g2 < keys2->length)){
HXLINE( 520)										int key = keys2->__get(_g2);
...
HXLINE( 521)					{
HXLINE( 521)						::Array< int > keys3 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_461,1);
HXDLIN( 521)						switch((int)(::Control_obj::RIGHT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 521)								{
HXLINE( 521)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 521)									int state = 1;
HXDLIN( 521)									int _g = 0;
HXDLIN( 521)									while((_g < keys3->length)){
HXLINE( 521)										int key = keys3->__get(_g);
HXDLIN( 521)										_g = (_g + 1);
...
HXDLIN( 521)									while((_g1 < keys3->length)){
HXLINE( 521)										int key = keys3->__get(_g1);
...
HXDLIN( 521)									while((_g2 < keys3->length)){
HXLINE( 521)										int key = keys3->__get(_g2);
...
HXLINE( 522)					{
HXLINE( 522)						::Array< int > keys4 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_462,1);
HXDLIN( 522)						switch((int)(::Control_obj::ACCEPT_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 522)								{
HXLINE( 522)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 522)									int state = 1;
HXDLIN( 522)									int _g = 0;
HXDLIN( 522)									while((_g < keys4->length)){
HXLINE( 522)										int key = keys4->__get(_g);
HXDLIN( 522)										_g = (_g + 1);
...
HXDLIN( 522)									while((_g1 < keys4->length)){
HXLINE( 522)										int key = keys4->__get(_g1);
...
HXDLIN( 522)									while((_g2 < keys4->length)){
HXLINE( 522)										int key = keys4->__get(_g2);
...
HXLINE( 523)					{
HXLINE( 523)						::Array< int > keys5 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_463,1);
HXDLIN( 523)						switch((int)(::Control_obj::BACK_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 523)								{
HXLINE( 523)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 523)									int state = 1;
HXDLIN( 523)									int _g = 0;
HXDLIN( 523)									while((_g < keys5->length)){
HXLINE( 523)										int key = keys5->__get(_g);
HXDLIN( 523)										_g = (_g + 1);
...
HXDLIN( 523)									while((_g1 < keys5->length)){
HXLINE( 523)										int key = keys5->__get(_g1);
...
HXDLIN( 523)									while((_g2 < keys5->length)){
HXLINE( 523)										int key = keys5->__get(_g2);
...
HXLINE( 524)					{
HXLINE( 524)						::Array< int > keys6 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_464,1);
HXDLIN( 524)						switch((int)(::Control_obj::PAUSE_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 524)								{
HXLINE( 524)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 524)									int state = 1;
HXDLIN( 524)									int _g = 0;
HXDLIN( 524)									while((_g < keys6->length)){
HXLINE( 524)										int key = keys6->__get(_g);
HXDLIN( 524)										_g = (_g + 1);
...
HXDLIN( 524)									while((_g1 < keys6->length)){
HXLINE( 524)										int key = keys6->__get(_g1);
...
HXDLIN( 524)									while((_g2 < keys6->length)){
HXLINE( 524)										int key = keys6->__get(_g2);
...
HXLINE( 525)					{
HXLINE( 525)						::Array< int > keys7 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_465,1);
HXDLIN( 525)						switch((int)(::Control_obj::RESET_dyn()->_hx_getIndex())){
            							case (int)0: {
HXLINE( 525)								{
HXLINE( 525)									 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 525)									int state = 1;
HXDLIN( 525)									int _g = 0;
HXDLIN( 525)									while((_g < keys7->length)){
HXLINE( 525)										int key = keys7->__get(_g);
HXDLIN( 525)										_g = (_g + 1);
...
HXDLIN( 525)									while((_g1 < keys7->length)){
HXLINE( 525)										int key = keys7->__get(_g1);
...
HXDLIN( 525)									while((_g2 < keys7->length)){
HXLINE( 525)										int key = keys7->__get(_g2);
...
void Controls_obj::removeKeyboard(){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_567_removeKeyboard)
HXDLIN( 567)		int _g = 0;
HXDLIN( 567)		::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 567)		while((_g < _g1->length)){
HXDLIN( 567)			 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 567)			_g = (_g + 1);
HXLINE( 569)			int i = action->inputs->length;
HXLINE( 570)			while(true){
HXLINE( 570)				i = (i - 1);
HXDLIN( 570)				if (!(((i + 1) > 0))) {
HXLINE( 570)					goto _hx_goto_467;
            				}
HXLINE( 572)				 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 573)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
HXLINE( 574)					action->remove(input,null());
            				}
            			}
            			_hx_goto_467:;
            		}
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_580_addGamepad)
HXLINE( 581)		this->gamepadsAdded->push(id);
HXLINE( 584)		{
HXLINE( 584)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
HXDLIN( 584)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 584)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 584)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 584)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 585)				{
HXLINE( 585)					int id1 = id;
HXDLIN( 585)					::Array< int > buttons1 = buttons;
HXDLIN( 585)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 585)								int state = 1;
HXDLIN( 585)								int _g = 0;
HXDLIN( 585)								while((_g < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g);
HXDLIN( 585)									_g = (_g + 1);
HXDLIN( 585)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 585)								int state1 = 2;
HXDLIN( 585)								int _g1 = 0;
HXDLIN( 585)								while((_g1 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g1);
HXDLIN( 585)									_g1 = (_g1 + 1);
HXDLIN( 585)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 585)								int state2 = -1;
HXDLIN( 585)								int _g2 = 0;
HXDLIN( 585)								while((_g2 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g2);
HXDLIN( 585)									_g2 = (_g2 + 1);
HXDLIN( 585)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 585)								int state = 1;
HXDLIN( 585)								int _g = 0;
HXDLIN( 585)								while((_g < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 585)								int state1 = 2;
HXDLIN( 585)								int _g1 = 0;
HXDLIN( 585)								while((_g1 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g1);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 585)								int state2 = -1;
HXDLIN( 585)								int _g2 = 0;
HXDLIN( 585)								while((_g2 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g2);
...
HXDLIN( 585)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXLINE( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 585)								int state = 1;
HXDLIN( 585)								int _g = 0;
HXDLIN( 585)								while((_g < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 585)								int state1 = 2;
HXDLIN( 585)								int _g1 = 0;
HXDLIN( 585)								while((_g1 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g1);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 585)								int state2 = -1;
HXDLIN( 585)								int _g2 = 0;
HXDLIN( 585)								while((_g2 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g2);
...
HXDLIN( 585)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXLINE( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 585)								int state = 1;
HXDLIN( 585)								int _g = 0;
HXDLIN( 585)								while((_g < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 585)								int state1 = 2;
HXDLIN( 585)								int _g1 = 0;
HXDLIN( 585)								while((_g1 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g1);
...
HXDLIN( 585)							{
HXLINE( 585)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 585)								int state2 = -1;
HXDLIN( 585)								int _g2 = 0;
HXDLIN( 585)								while((_g2 < buttons1->length)){
HXLINE( 585)									int button = buttons1->__get(_g2);
...
HXDLIN( 585)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXLINE( 585)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
HXDLIN( 585)							int state = 2;
HXDLIN( 585)							int _g = 0;
HXDLIN( 585)							while((_g < buttons1->length)){
HXLINE( 585)								int button = buttons1->__get(_g);
HXDLIN( 585)								_g = (_g + 1);
HXDLIN( 585)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXLINE( 585)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 585)							int state = 2;
HXDLIN( 585)							int _g = 0;
HXDLIN( 585)							while((_g < buttons1->length)){
HXLINE( 585)								int button = buttons1->__get(_g);
...
HXDLIN( 585)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXLINE( 585)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 585)							int state = 2;
HXDLIN( 585)							int _g = 0;
HXDLIN( 585)							while((_g < buttons1->length)){
HXLINE( 585)								int button = buttons1->__get(_g);
...
HXDLIN( 585)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXLINE( 585)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 585)							int state = 2;
HXDLIN( 585)							int _g = 0;
HXDLIN( 585)							while((_g < buttons1->length)){
HXLINE( 585)								int button = buttons1->__get(_g);
...
HXDLIN( 585)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXLINE( 585)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 585)							int state = 2;
HXDLIN( 585)							int _g = 0;
HXDLIN( 585)							while((_g < buttons1->length)){
HXLINE( 585)								int button = buttons1->__get(_g);
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_593_addGamepadLiteral)
HXLINE( 594)		this->gamepadsAdded->push(id);
HXLINE( 597)		{
HXLINE( 597)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
...
HXDLIN( 597)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 597)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 598)				{
HXLINE( 598)					int id1 = id;
HXDLIN( 598)					::Array< int > buttons1 = buttons;
HXDLIN( 598)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 598)							{
HXLINE( 598)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 598)								int state = 1;
HXDLIN( 598)								int _g = 0;
HXDLIN( 598)								while((_g < buttons1->length)){
HXLINE( 598)									int button = buttons1->__get(_g);
HXDLIN( 598)									_g = (_g + 1);
HXDLIN( 598)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 598)							{
...
HXDLIN( 598)								while((_g1 < buttons1->length)){
HXLINE( 598)									int button = buttons1->__get(_g1);
HXDLIN( 598)									_g1 = (_g1 + 1);
HXDLIN( 598)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 598)							{
...
HXDLIN( 598)								while((_g2 < buttons1->length)){
HXLINE( 598)									int button = buttons1->__get(_g2);
HXDLIN( 598)									_g2 = (_g2 + 1);
HXDLIN( 598)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
...
void Controls_obj::removeGamepad(::hx::Null< int >  __o_deviceID){
            	...
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_606_removeGamepad)
HXLINE( 607)		{
HXLINE( 607)			int _g = 0;
HXDLIN( 607)			::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 607)			while((_g < _g1->length)){
HXLINE( 607)				 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 607)				_g = (_g + 1);
HXLINE( 609)				int i = action->inputs->length;
HXLINE( 610)				while(true){
HXLINE( 610)					i = (i - 1);
HXDLIN( 610)					if (!(((i + 1) > 0))) {
HXLINE( 610)						goto _hx_goto_508;
            					}
HXLINE( 612)					 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 613)					bool _hx_tmp;
HXDLIN( 613)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 613)						if ((deviceID != -1)) {
HXLINE( 613)							_hx_tmp = (input->deviceID == deviceID);
            						}
            						else {
...
HXLINE( 614)						action->remove(input,null());
            					}
            				}
            				_hx_goto_508:;
            			}
            		}
HXLINE( 618)		this->gamepadsAdded->remove(deviceID);
            	}
...
void Controls_obj::addDefaultGamepad(int id){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_624_addDefaultGamepad)
HXDLIN( 624)		 ::haxe::ds::EnumValueMap _g =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN( 624)		_g->set(::Control_obj::ACCEPT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_529,1));
HXDLIN( 624)		_g->set(::Control_obj::BACK_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_530,1));
HXDLIN( 624)		_g->set(::Control_obj::UP_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_531,2));
HXDLIN( 624)		_g->set(::Control_obj::DOWN_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_532,2));
HXDLIN( 624)		_g->set(::Control_obj::LEFT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_533,2));
HXDLIN( 624)		_g->set(::Control_obj::RIGHT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_534,2));
HXDLIN( 624)		_g->set(::Control_obj::PAUSE_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_535,1));
HXDLIN( 624)		_g->set(::Control_obj::RESET_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_536,1));
HXDLIN( 624)		this->gamepadsAdded->push(id);
HXDLIN( 624)		{
HXDLIN( 624)			 ::Dynamic _g1 =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,_g);
HXDLIN( 624)			while(( (bool)(_g1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 624)				 ::Dynamic _g = _g1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 624)				 ::Control control = _g->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 624)				::Array< int > buttons = ( (::Array< int >)(_g->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXDLIN( 624)				{
HXDLIN( 624)					int id1 = id;
HXDLIN( 624)					::Array< int > buttons1 = buttons;
HXDLIN( 624)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 624)								int state = 1;
HXDLIN( 624)								int _g = 0;
HXDLIN( 624)								while((_g < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g);
HXDLIN( 624)									_g = (_g + 1);
HXDLIN( 624)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 624)								int state1 = 2;
HXDLIN( 624)								int _g1 = 0;
HXDLIN( 624)								while((_g1 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g1);
HXDLIN( 624)									_g1 = (_g1 + 1);
HXDLIN( 624)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 624)								int state2 = -1;
HXDLIN( 624)								int _g2 = 0;
HXDLIN( 624)								while((_g2 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g2);
...
HXDLIN( 624)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)1: {
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 624)								int state = 1;
HXDLIN( 624)								int _g = 0;
HXDLIN( 624)								while((_g < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 624)								int state1 = 2;
HXDLIN( 624)								int _g1 = 0;
HXDLIN( 624)								while((_g1 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g1);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 624)								int state2 = -1;
HXDLIN( 624)								int _g2 = 0;
HXDLIN( 624)								while((_g2 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g2);
...
HXDLIN( 624)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 624)								int state = 1;
HXDLIN( 624)								int _g = 0;
HXDLIN( 624)								while((_g < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 624)								int state1 = 2;
HXDLIN( 624)								int _g1 = 0;
HXDLIN( 624)								while((_g1 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g1);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 624)								int state2 = -1;
HXDLIN( 624)								int _g2 = 0;
HXDLIN( 624)								while((_g2 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g2);
...
HXDLIN( 624)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 624)								int state = 1;
HXDLIN( 624)								int _g = 0;
HXDLIN( 624)								while((_g < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 624)								int state1 = 2;
HXDLIN( 624)								int _g1 = 0;
HXDLIN( 624)								while((_g1 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g1);
...
HXDLIN( 624)							{
HXDLIN( 624)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 624)								int state2 = -1;
HXDLIN( 624)								int _g2 = 0;
HXDLIN( 624)								while((_g2 < buttons1->length)){
HXDLIN( 624)									int button = buttons1->__get(_g2);
...
HXDLIN( 624)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXDLIN( 624)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
...
HXDLIN( 624)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXDLIN( 624)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 624)							int state = 2;
HXDLIN( 624)							int _g = 0;
HXDLIN( 624)							while((_g < buttons1->length)){
HXDLIN( 624)								int button = buttons1->__get(_g);
...
HXDLIN( 624)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXDLIN( 624)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 624)							int state = 2;
HXDLIN( 624)							int _g = 0;
HXDLIN( 624)							while((_g < buttons1->length)){
HXDLIN( 624)								int button = buttons1->__get(_g);
...
HXDLIN( 624)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXDLIN( 624)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 624)							int state = 2;
HXDLIN( 624)							int _g = 0;
HXDLIN( 624)							while((_g < buttons1->length)){
HXDLIN( 624)								int button = buttons1->__get(_g);
...
HXDLIN( 624)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXDLIN( 624)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 624)							int state = 2;
HXDLIN( 624)							int _g = 0;
HXDLIN( 624)							while((_g < buttons1->length)){
HXDLIN( 624)								int button = buttons1->__get(_g);
...
void Controls_obj::bindButtons( ::Control control,int id,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_658_bindButtons)
HXDLIN( 658)		switch((int)(control->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 658)					int state = 1;
HXDLIN( 658)					int _g = 0;
HXDLIN( 658)					while((_g < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g);
HXDLIN( 658)						_g = (_g + 1);
HXDLIN( 658)						action->addGamepad(button,state,id);
            					}
            				}
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 658)					int state1 = 2;
HXDLIN( 658)					int _g1 = 0;
HXDLIN( 658)					while((_g1 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g1);
HXDLIN( 658)						_g1 = (_g1 + 1);
HXDLIN( 658)						action1->addGamepad(button,state1,id);
            					}
            				}
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 658)					int state2 = -1;
HXDLIN( 658)					int _g2 = 0;
HXDLIN( 658)					while((_g2 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g2);
HXDLIN( 658)						_g2 = (_g2 + 1);
HXDLIN( 658)						action2->addGamepad(button,state2,id);
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 658)					int state = 1;
HXDLIN( 658)					int _g = 0;
HXDLIN( 658)					while((_g < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 658)					int state1 = 2;
HXDLIN( 658)					int _g1 = 0;
HXDLIN( 658)					while((_g1 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g1);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 658)					int state2 = -1;
HXDLIN( 658)					int _g2 = 0;
HXDLIN( 658)					while((_g2 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g2);
...
HXDLIN( 658)						action2->addGamepad(button,state2,id);
            			...
            			case (int)2: {
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 658)					int state = 1;
HXDLIN( 658)					int _g = 0;
HXDLIN( 658)					while((_g < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 658)					int state1 = 2;
HXDLIN( 658)					int _g1 = 0;
HXDLIN( 658)					while((_g1 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g1);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 658)					int state2 = -1;
HXDLIN( 658)					int _g2 = 0;
HXDLIN( 658)					while((_g2 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g2);
...
HXDLIN( 658)						action2->addGamepad(button,state2,id);
            			...
            			case (int)3: {
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 658)					int state = 1;
HXDLIN( 658)					int _g = 0;
HXDLIN( 658)					while((_g < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 658)					int state1 = 2;
HXDLIN( 658)					int _g1 = 0;
HXDLIN( 658)					while((_g1 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g1);
...
HXDLIN( 658)				{
HXDLIN( 658)					 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 658)					int state2 = -1;
HXDLIN( 658)					int _g2 = 0;
HXDLIN( 658)					while((_g2 < buttons->length)){
HXDLIN( 658)						int button = buttons->__get(_g2);
...
HXDLIN( 658)						action2->addGamepad(button,state2,id);
            			...
            			break;
            			case (int)4: {
HXDLIN( 658)				 ::flixel::input::actions::FlxActionDigital action = this->_reset;
...
HXDLIN( 658)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)5: {
HXDLIN( 658)				 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 658)				int state = 2;
HXDLIN( 658)				int _g = 0;
HXDLIN( 658)				while((_g < buttons->length)){
HXDLIN( 658)					int button = buttons->__get(_g);
...
HXDLIN( 658)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)6: {
HXDLIN( 658)				 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 658)				int state = 2;
HXDLIN( 658)				int _g = 0;
HXDLIN( 658)				while((_g < buttons->length)){
HXDLIN( 658)					int button = buttons->__get(_g);
...
HXDLIN( 658)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)7: {
HXDLIN( 658)				 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 658)				int state = 2;
HXDLIN( 658)				int _g = 0;
HXDLIN( 658)				while((_g < buttons->length)){
HXDLIN( 658)					int button = buttons->__get(_g);
...
HXDLIN( 658)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)8: {
HXDLIN( 658)				 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 658)				int state = 2;
HXDLIN( 658)				int _g = 0;
HXDLIN( 658)				while((_g < buttons->length)){
HXDLIN( 658)					int button = buttons->__get(_g);
...
void Controls_obj::unbindButtons( ::Control control,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_671_unbindButtons)
HXDLIN( 671)		switch((int)(control->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_up,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_upP,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_upR,gamepadID,buttons);
            			}
            			break;
            			case (int)1: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_left,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_leftP,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_leftR,gamepadID,buttons);
            			}
            			break;
            			case (int)2: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_right,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_rightP,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_rightR,gamepadID,buttons);
            			}
            			break;
            			case (int)3: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_down,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_downP,gamepadID,buttons);
HXDLIN( 671)				::Controls_obj::removeButtons(this->_downR,gamepadID,buttons);
            			}
            			break;
            			case (int)4: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_reset,gamepadID,buttons);
            			}
            			break;
            			case (int)5: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_accept,gamepadID,buttons);
            			}
            			break;
            			case (int)6: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_back,gamepadID,buttons);
            			}
            			break;
            			case (int)7: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_pause,gamepadID,buttons);
            			}
            			break;
            			case (int)8: {
HXDLIN( 671)				::Controls_obj::removeButtons(this->_cheat,gamepadID,buttons);
            			}
            			break;
            		}
            	}
...
::Array< int > Controls_obj::getInputsFor( ::Control control, ::Device device,::Array< int > list){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_695_getInputsFor)
HXLINE( 696)		if (::hx::IsNull( list )) {
HXLINE( 697)			list = ::Array_obj< int >::__new(0);
            		}
HXLINE( 699)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 702)				int _g = 0;
HXDLIN( 702)				::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 702)				while((_g < _g1->length)){
HXLINE( 702)					 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 702)					_g = (_g + 1);
HXLINE( 704)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
HXLINE( 705)						list->push(input->inputID);
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 707)				int id = device->_hx_getInt(0);
HXLINE( 708)				{
HXLINE( 708)					int _g = 0;
HXDLIN( 708)					::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 708)					while((_g < _g1->length)){
HXLINE( 708)						 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 708)						_g = (_g + 1);
HXLINE( 710)						if ((input->deviceID == id)) {
HXLINE( 711)							list->push(input->inputID);
            						}
            					}
            				}
            			}
...
void Controls_obj::removeDevice( ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_719_removeDevice)
HXDLIN( 719)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 722)				this->setKeyboardScheme(::KeyboardScheme_obj::None_dyn(),null());
            			}
            			break;
            			case (int)1: {
HXLINE( 723)				int id = device->_hx_getInt(0);
HXLINE( 724)				this->removeGamepad(id);
            			}
            			break;
            		}
            	}
...
void Controls_obj::addButtons( ::flixel::input::actions::FlxActionDigital action,::Array< int > buttons,int state,int id){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_679_addButtons)
HXDLIN( 679)		int _g = 0;
HXDLIN( 679)		while((_g < buttons->length)){
HXDLIN( 679)			int button = buttons->__get(_g);
HXDLIN( 679)			_g = (_g + 1);
HXLINE( 680)			action->addGamepad(button,state,id);
            		}
            	}
...
void Controls_obj::removeButtons( ::flixel::input::actions::FlxActionDigital action,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_684_removeButtons)
HXLINE( 685)		int i = action->inputs->length;
HXLINE( 686)		while(true){
HXLINE( 686)			i = (i - 1);
HXDLIN( 686)			if (!(((i + 1) > 0))) {
HXLINE( 686)				goto _hx_goto_567;
            			}
HXLINE( 688)			 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 689)			bool _hx_tmp;
HXDLIN( 689)			bool _hx_tmp1;
HXDLIN( 689)			if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 689)				if ((gamepadID != -1)) {
HXLINE( 689)					_hx_tmp1 = (input->deviceID == gamepadID);
            				}
            				else {
...
HXLINE( 689)				_hx_tmp = (buttons->indexOf(input->inputID,null()) != -1);
            			}
            			else {
HXLINE( 689)				_hx_tmp = false;
            			}
HXDLIN( 689)			if (_hx_tmp) {
HXLINE( 690)				action->remove(input,null());
            			}
            		}
            		_hx_goto_567:;
            	}
...
bool Controls_obj::isDevice( ::flixel::input::actions::FlxActionInput input, ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_730_isDevice)
HXDLIN( 730)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 732)				return ::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 733)				int id = device->_hx_getInt(0);
HXDLIN( 733)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 733)					if ((id != -1)) {
HXLINE( 733)						return (input->deviceID == id);
            					}
            					else {
...
bool Controls_obj::isGamepad( ::flixel::input::actions::FlxActionInput input,int deviceID){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_739_isGamepad)
HXDLIN( 739)		if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXDLIN( 739)			if ((deviceID != -1)) {
HXDLIN( 739)				return (input->deviceID == deviceID);
            			}
            			else {
HXDLIN( 739)				return true;
            			}
            		}
            		else {
HXDLIN( 739)			return false;
            		}
HXDLIN( 739)		return false;
            	}
