...
HX_LOCAL_STACK_FRAME(_hx_pos_8feeea0724e4c481_832_copyVal,"polymod.format.JSONParseFormat","copyVal",0xfb3ed381,"polymod.format.JSONParseFormat.copyVal","polymod/format/ParseRules.hx",832,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_8feeea0724e4c481_843_isPrimitive,"polymod.format.JSONParseFormat","isPrimitive",0xd2508732,"polymod.format.JSONParseFormat.isPrimitive","polymod/format/ParseRules.hx",843,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_8feeea0724e4c481_852__descend,"polymod.format.JSONParseFormat","_descend",0x5bcab8b6,"polymod.format.JSONParseFormat._descend","polymod/format/ParseRules.hx",852,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_8feeea0724e4c481_920__getTargetSignature,"polymod.format.JSONParseFormat","_getTargetSignature",0x1f3de665,"polymod.format.JSONParseFormat._getTargetSignature","polymod/format/ParseRules.hx",920,0xc5c5c43b)
HX_LOCAL_STACK_FRAME(_hx_pos_8feeea0724e4c481_958_print,"polymod.format.JSONParseFormat","print",0xa25c6242,"polymod.format.JSONParseFormat.print","polymod/format/ParseRules.hx",958,0xc5c5c43b)
namespace polymod{
namespace format{
...
void *JSONParseFormat_obj::_hx_getInterface(int inHash) {
 ...
 ::haxe::Json JSONParseFormat_obj::parse(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_8feeea0724e4c481_582_parse)
HXDLIN( 582)		return ( ( ::haxe::Json)( ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,str)->doParse()) );
            	}
...
HXLINE( 657)		return this->print(( ( ::haxe::Json)(base) ));
            	}
...
HXLINE( 774)				int _g = 0;
HXDLIN( 774)				::Array< ::String > _g1 = ::Reflect_obj::fields(b);
HXDLIN( 774)				while((_g < _g1->length)){
HXLINE( 774)					::String field = _g1->__get(_g);
HXDLIN( 774)					_g = (_g + 1);
HXLINE( 776)					if (::Reflect_obj::hasField(a,field)) {
HXLINE( 779)						 ::Dynamic aValue = ::Reflect_obj::field(a,field);
HXLINE( 780)						 ::Dynamic bValue = ::Reflect_obj::field(b,field);
HXLINE( 781)						bool _hx_tmp;
HXDLIN( 781)						if (::Std_obj::isOfType(aValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 781)							_hx_tmp = ::Std_obj::isOfType(bValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ));
            						}
            						else {
HXLINE( 781)							_hx_tmp = false;
            						}
HXDLIN( 781)						if (_hx_tmp) {
HXLINE( 784)							::Reflect_obj::setField(a,field,bValue);
            						}
            						else {
HXLINE( 786)							bool _hx_tmp;
HXDLIN( 786)							if (!(::Std_obj::isOfType(aValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) )))) {
HXLINE( 786)								_hx_tmp = !(::Std_obj::isOfType(bValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) )));
            							}
            							else {
HXLINE( 786)								_hx_tmp = false;
            							}
HXDLIN( 786)							if (_hx_tmp) {
HXLINE( 788)								bool aPrimitive = this->isPrimitive(a);
HXLINE( 789)								bool bPrimitive = this->isPrimitive(b);
HXLINE( 790)								bool _hx_tmp;
HXDLIN( 790)								if (aPrimitive) {
HXLINE( 790)									_hx_tmp = bPrimitive;
            								}
            								else {
HXLINE( 790)									_hx_tmp = false;
            								}
HXDLIN( 790)								if (_hx_tmp) {
HXLINE( 793)									return bValue;
            								}
            								else {
HXLINE( 795)									if ((aPrimitive != bPrimitive)) {
HXLINE( 798)										return aValue;
            									}
            								}
HXLINE( 802)								 ::Dynamic mergedValue = this->copyVal(this->_mergeObjects(aValue,bValue,((signatureSoFar + HX_(".",2e,00,00,00)) + field)));
HXLINE( 803)								::Reflect_obj::setField(a,field,mergedValue);
HXLINE( 804)								return a;
            							}
            							else {
HXLINE( 809)								::String aArr;
HXDLIN( 809)								if (::Std_obj::isOfType(aValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
...
HXDLIN( 810)								if (::Std_obj::isOfType(bValue,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 810)									bArr = HX_("array",99,6d,8f,25);
            								}
            								else {
HXLINE( 810)									bArr = HX_("object",bf,7e,3f,15);
            								}
HXLINE( 811)								::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),((((((((HX_("Can't merge field (",d7,50,4b,7f) + field) + HX_(") @ (",d1,48,c5,b0)) + signatureSoFar) + HX_(") because base is (",50,8e,37,ae)) + aArr) + HX_(") but payload is (",5a,2e,59,4c)) + bArr) + HX_(")",29,00,00,00)),null());
            							}
            						}
            					}
            					else {
HXLINE( 817)						::Reflect_obj::setField(a,field,::Reflect_obj::field(b,field));
            					}
            				}
            			}
            			else {
HXLINE( 824)				::String aArr;
HXDLIN( 824)				if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 824)					aArr = HX_("array",99,6d,8f,25);
            				}
            				else {
HXLINE( 824)					aArr = HX_("object",bf,7e,3f,15);
            				}
HXLINE( 825)				::String bArr;
HXDLIN( 825)				if (::Std_obj::isOfType(b,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 825)					bArr = HX_("array",99,6d,8f,25);
            				}
            				else {
HXLINE( 825)					bArr = HX_("object",bf,7e,3f,15);
            				}
HXLINE( 826)				::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),((((((HX_("JSON can't merge @ (",85,71,3f,d3) + signatureSoFar) + HX_(") because base is (",50,8e,37,ae)) + aArr) + HX_(") but payload is (",5a,2e,59,4c)) + bArr) + HX_(")",29,00,00,00)),null());
            			}
            		}
HXLINE( 828)		return a;
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(JSONParseFormat_obj,_mergeObjects,return )
 ...
 ::Dynamic JSONParseFormat_obj::copyVal( ::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_8feeea0724e4c481_832_copyVal)
HXLINE( 833)		 ::Dynamic b = null();
HXLINE( 834)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< int >()) ))) {
HXLINE( 834)			b = ::Std_obj::_hx_int(( (Float)(a) ));
            		}
HXLINE( 835)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< ::Float >()) ))) {
HXLINE( 835)			b = ::hx::TCast< Float >::cast(a);
            		}
HXLINE( 836)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< ::String >()) ))) {
HXLINE( 836)			b = ::Std_obj::string(b);
            		}
HXLINE( 837)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< bool >()) ))) {
HXLINE( 837)			b = ::hx::IsEq( a,true );
            		}
            		else {
HXLINE( 838)			b = ::Std_obj::string(a);
            		}
HXLINE( 839)		return b;
            	}
...
bool JSONParseFormat_obj::isPrimitive( ::Dynamic a){
            	HX_STACKFRAME(&_hx_pos_8feeea0724e4c481_843_isPrimitive)
HXLINE( 844)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< ::String >()) ))) {
HXLINE( 844)			return true;
            		}
HXLINE( 845)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< ::Float >()) ))) {
HXLINE( 845)			return true;
            		}
HXLINE( 846)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< int >()) ))) {
HXLINE( 846)			return true;
            		}
HXLINE( 847)		if (::Std_obj::isOfType(a,( ( ::Dynamic)(::hx::ClassOf< bool >()) ))) {
HXLINE( 847)			return true;
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(JSONParseFormat_obj,isPrimitive,return )
 ...
 ::Dynamic JSONParseFormat_obj::_descend( ::Dynamic obj, ::Dynamic target,::String __o_signatureSoFar, ::Dynamic _hx_struct){
            		::String signatureSoFar = __o_signatureSoFar;
            		if (::hx::IsNull(__o_signatureSoFar)) signatureSoFar = HX_("",00,00,00,00);
            	HX_STACKFRAME(&_hx_pos_8feeea0724e4c481_852__descend)
HXLINE( 853)		if (::hx::IsNull( _hx_struct )) {
HXLINE( 855)			_hx_struct =  ::Dynamic(::hx::Anon_obj::Create(4)
            				->setFixed(0,HX_("target",51,f3,ec,86),null())
            				->setFixed(1,HX_("parent",2a,05,7e,ed),null())
            				->setFixed(2,HX_("arrIndex",f1,4c,9d,16),-1)
            				->setFixed(3,HX_("next",f3,84,02,49),null()));
            		}
HXLINE( 857)		if (::hx::IsNull( obj )) {
HXLINE( 857)			return null();
            		}
HXLINE( 858)		if (::hx::IsNull( target )) {
HXLINE( 858)			return null();
            		}
HXLINE( 860)		if ((::Reflect_obj::hasField(obj,( (::String)(target->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) )) == false)) {
HXLINE( 862)			::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),( (::String)(((((HX_("JSON merge error : object (",e5,d3,7c,c6) + signatureSoFar) + HX_(") has no field (",80,c1,77,e8)) + target->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) + HX_(")",29,00,00,00))) ),null());
HXLINE( 863)			return null();
            		}
HXLINE( 865)		 ::Dynamic next = ::Reflect_obj::field(obj,( (::String)(target->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) ));
HXLINE( 867)		_hx_struct->__SetField(HX_("next",f3,84,02,49),next,::hx::paccDynamic);
HXLINE( 868)		_hx_struct->__SetField(HX_("parent",2a,05,7e,ed),obj,::hx::paccDynamic);
HXLINE( 869)		_hx_struct->__SetField(HX_("target",51,f3,ec,86),target->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic),::hx::paccDynamic);
HXLINE( 871)		if (::hx::IsNull( next )) {
HXLINE( 873)			return _hx_struct;
            		}
HXLINE( 875)		if ((( (::Array< int >)(target->__Field(HX_("arrayIndeces",12,fc,0e,92),::hx::paccDynamic)) )->length > 0)) {
HXLINE( 877)			_hx_struct->__SetField(HX_("next",f3,84,02,49),next,::hx::paccDynamic);
HXLINE( 878)			if (::Std_obj::isOfType(next,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 880)				::cpp::VirtualArray arr = ( (::cpp::VirtualArray)(next) );
HXLINE( 881)				::Array< int > arrIndeces = ( (::Array< int >)(target->__Field(HX_("arrayIndeces",12,fc,0e,92),::hx::paccDynamic)) )->copy();
HXLINE( 882)				bool done = false;
HXLINE( 883)				signatureSoFar = ( (::String)((signatureSoFar + (HX_(".",2e,00,00,00) + target->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)))) );
HXLINE( 884)				while((arrIndeces->length > 0)){
HXLINE( 886)					 ::Dynamic arrIndex = arrIndeces->shift();
HXLINE( 887)					if (::hx::IsLess( arrIndex,arr->get_length() )) {
HXLINE( 889)						_hx_struct->__SetField(HX_("parent",2a,05,7e,ed),next,::hx::paccDynamic);
HXLINE( 890)						next = arr->__get(( (int)(arrIndex) ));
HXLINE( 891)						_hx_struct->__SetField(HX_("next",f3,84,02,49),next,::hx::paccDynamic);
HXLINE( 892)						_hx_struct->__SetField(HX_("arrIndex",f1,4c,9d,16),arrIndex,::hx::paccDynamic);
HXLINE( 893)						if (::Std_obj::isOfType(next,( ( ::Dynamic)(::hx::ArrayBase::__mClass) ))) {
HXLINE( 895)							arr = ( (::cpp::VirtualArray)(next) );
            						}
            						else {
HXLINE( 899)							::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),((((HX_("JSON merge error : invalid array access [",2d,d9,47,04) + arrIndex) + HX_("] on target \"",71,b4,05,40)) + signatureSoFar) + HX_("\"",22,00,00,00)),null());
HXLINE( 900)							done = true;
            						}
            					}
            					else {
HXLINE( 905)						::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),(((((HX_("JSON merge error : array index (",f5,d1,14,72) + arrIndex) + HX_(") out of bounds on target \"",29,e2,45,b0)) + signatureSoFar) + HX_("\" with length ",1e,a7,04,80)) + arr->get_length()),null());
HXLINE( 906)						done = true;
            					}
HXLINE( 908)					signatureSoFar = (signatureSoFar + ((HX_("[",5b,00,00,00) + arrIndex) + HX_("]",5d,00,00,00)));
            				}
            			}
            			else {
...
::Array< ::Dynamic> JSONParseFormat_obj::_getTargetSignature(::String str){
            	HX_STACKFRAME(&_hx_pos_8feeea0724e4c481_920__getTargetSignature)
HXLINE( 921)		if (::hx::IsNull( str )) {
HXLINE( 921)			return ::Array_obj< ::Dynamic>::__new(0);
            		}
HXLINE( 922)		::Array< ::Dynamic> result = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 923)		::Array< ::String > arr = str.split(HX_(".",2e,00,00,00));
HXLINE( 924)		{
HXLINE( 924)			int _g = 0;
HXDLIN( 924)			while((_g < arr->length)){
HXLINE( 924)				::String bit = arr->__get(_g);
HXDLIN( 924)				_g = (_g + 1);
HXLINE( 926)				if ((bit.indexOf(HX_("[",5b,00,00,00),null()) != -1)) {
HXLINE( 928)					::Array< ::String > arr2 = bit.split(HX_("[",5b,00,00,00));
HXLINE( 929)					::String value = ( (::String)(arr2->shift()) );
HXLINE( 930)					::Array< ::Dynamic> arrayIndeces = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 931)					while((arr2->length > 0)){
HXLINE( 933)						::String value2 = ( (::String)(arr2->shift()) );
HXLINE( 934)						value2 = ::polymod::util::Util_obj::uTrimFinalCharIf(value2,HX_("]",5d,00,00,00));
HXLINE( 935)						 ::Dynamic arrIndex = ::Std_obj::parseInt(value2);
HXLINE( 936)						bool _hx_tmp;
HXDLIN( 936)						if (::hx::IsNotNull( arrIndex )) {
HXLINE( 936)							_hx_tmp = ::hx::IsGreaterEq( arrIndex,0 );
            						}
            						else {
HXLINE( 936)							_hx_tmp = false;
            						}
HXDLIN( 936)						if (_hx_tmp) {
HXLINE( 938)							arrayIndeces->push(arrIndex);
            						}
            						else {
HXLINE( 942)							::polymod::Polymod_obj::warning(HX_("merge_error",c1,8f,ea,85),((((HX_("JSON merge error: found invalid array index (",7e,22,f3,0f) + value2) + HX_(") in signature (",5c,ce,b9,91)) + str) + HX_(")",29,00,00,00)),null());
HXLINE( 943)							goto _hx_goto_17;
            						}
            					}
            					_hx_goto_17:;
HXLINE( 946)					result->push( ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("arrayIndeces",12,fc,0e,92),arrayIndeces)
            						->setFixed(1,HX_("value",71,7f,b8,31),value)));
            				}
            				else {
HXLINE( 950)					result->push( ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("arrayIndeces",12,fc,0e,92),::Array_obj< ::Dynamic>::__new(0))
            						->setFixed(1,HX_("value",71,7f,b8,31),bit)));
            				}
            			}
            		}
HXLINE( 953)		return result;
            	}


HX_DEFINE_DYNAMIC_FUNC1(JSONParseFormat_obj,_getTargetSignature,return )

::String JSONParseFormat_obj::print( ::haxe::Json data){
            	HX_STACKFRAME(&_hx_pos_8feeea0724e4c481_958_print)
HXDLIN( 958)		return ::haxe::format::JsonPrinter_obj::print(data,this->replacer,this->space);
            	}
