...
HX_DEFINE_STACK_FRAME(_hx_pos_693271197a257090_47_new,"flixel.system.debug._VCR.GraphicPause","new",0x93ef75a0,"flixel.system.debug._VCR.GraphicPause.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_f15d3e565d22c2bd_17_boot,"flixel.system.debug._VCR.GraphicPause","boot",0xd5b076f2,"flixel.system.debug._VCR.GraphicPause.boot","flixel/system/debug/VCR.hx",17,0x4ecb3ec2)
namespace flixel{
...
void GraphicPause_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_693271197a257090_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  73)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicPause_obj::resourceName));
HXLINE(  74)		{
...
bool GraphicPause_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x5222bf18;
	}
}
...
static ::hx::StaticInfo GraphicPause_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &GraphicPause_obj::resourceName,HX_("resourceName",39,7a,62,90)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	GraphicPause_obj _hx_dummy;
	GraphicPause_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("flixel.system.debug._VCR.GraphicPause",ae,65,e4,8a);
...
{
{
            	HX_STACKFRAME(&_hx_pos_f15d3e565d22c2bd_17_boot)
HXDLIN(  17)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicPause",c8,9f,12,2a);
            	}
}
