...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_121_update,"LoadingState","update",0x70c61742,"LoadingState.update","LoadingState.hx",121,0x53ff9bc9)
...
void LoadingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_121_update)
...
HXDLIN( 124)		if (_this->keyManager->checkStatus(32,_this->status)) {
HXLINE( 125)			 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 125)			::String _hx_tmp1 = ((HX_("fired: ",14,f6,c2,73) + ::Std_obj::string(this->callbacks->getFired())) + HX_(" unfired:",c5,53,95,e9));
HXDLIN( 125)			::String _hx_tmp2 = (_hx_tmp1 + ::Std_obj::string(this->callbacks->getUnfired()));
HXDLIN( 125)			_hx_tmp(_hx_tmp2,::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),125,HX_("LoadingState",15,62,ae,41),HX_("update",09,86,05,87)));
            		}
            	}
...
HXDLIN( 139)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + ( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
