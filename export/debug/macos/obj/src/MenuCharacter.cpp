...
HXLINE(  56)		this->animation->addByPrefix(HX_("kanye-bear",bd,7b,12,14),HX_("kanye bear menu",8f,96,e6,52),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("kanye-bear",bd,7b,12,14), ::CharacterSetting_obj::__alloc( HX_CTX ,-15,130,null(),null()));
HXDLIN(  24)			return _g;
            		}
