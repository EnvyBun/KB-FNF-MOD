...
HXLINE( 126)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 128)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 130)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 130)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXLINE( 215)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN(  39)		nightly = HX_("-Nightly2",7a,8b,89,ed);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_41_boot)
HXDLIN(  41)		kadeEngineVer = (HX_("1.4.1",ba,da,31,55) + ::MainMenuState_obj::nightly);
            	}
{
