...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_183_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",183,0x1a8855ec)
...
HXLINE(  48)		{
HXLINE(  48)			 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  48)			_g->set_x((_g->x + 50));
            		}
HXLINE(  50)		{
HXLINE(  50)			 ::Note _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  50)			_g1->set_y((_g1->y - ( (Float)(2000) )));
            		}
HXLINE(  51)		this->strumTime = strumTime;
HXLINE(  53)		if ((this->strumTime < 0)) {
...
HXLINE(  63)			::String library = null();
HXDLIN(  63)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrows-pixels",b7,c3,c7,09)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,17,17,null(),null());
...
HXDLIN(  72)				this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrowEnds",08,21,6c,fd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,7,6,null(),null());
...
HXDLIN(  89)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  89)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXDLIN( 132)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXLINE( 132)			_hx_tmp = ( (bool)(sustainNote) );
            		}
            		else {
HXLINE( 132)			_hx_tmp = false;
            		}
HXDLIN( 132)		if (_hx_tmp) {
HXLINE( 133)			this->set_flipY(true);
            		}
HXLINE( 135)		bool _hx_tmp1;
HXDLIN( 135)		if (this->isSustainNote) {
HXLINE( 135)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 135)			_hx_tmp1 = false;
            		}
HXDLIN( 135)		if (_hx_tmp1) {
HXLINE( 138)			this->set_alpha(((Float)0.6));
HXLINE( 140)			{
HXLINE( 140)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 140)				Float _g1 = _g->x;
HXDLIN( 140)				_g->set_x((_g1 + (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 142)			switch((int)(noteData)){
            				case (int)0: {
HXLINE( 151)					this->animation->play(HX_("purpleholdend",40,d5,15,5b),null(),null(),null());
            				}
            				break;
            				case (int)1: {
HXLINE( 149)					this->animation->play(HX_("blueholdend",a2,f0,cd,25),null(),null(),null());
            				...
            				break;
            				case (int)2: {
HXLINE( 145)					this->animation->play(HX_("greenholdend",99,eb,5f,39),null(),null(),null());
            				}
            				break;
            				case (int)3: {
HXLINE( 147)					this->animation->play(HX_("redholdend",cb,ae,1e,ea),null(),null(),null());
            				}
            				break;
            			}
HXLINE( 154)			this->updateHitbox();
HXLINE( 156)			{
HXLINE( 156)				 ::Note _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 156)				Float _g3 = _g2->x;
HXDLIN( 156)				_g2->set_x((_g3 - (this->get_width() / ( (Float)(2) ))));
            			}
HXLINE( 158)			if (::StringTools_obj::startsWith(::PlayState_obj::curStage,HX_("school",74,b8,c8,40))) {
HXLINE( 159)				 ::Note _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 159)				_g->set_x((_g->x + 30));
            			}
HXLINE( 161)			if (prevNote->isSustainNote) {
HXLINE( 163)				switch((int)(prevNote->noteData)){
            					case (int)0: {
HXLINE( 166)						prevNote->animation->play(HX_("purplehold",7b,8d,da,cd),null(),null(),null());
            					}
            					break;
            					case (int)1: {
HXLINE( 168)						prevNote->animation->play(HX_("bluehold",d9,60,aa,a4),null(),null(),null());
            					}
            					break;
            					case (int)2: {
HXLINE( 170)						prevNote->animation->play(HX_("greenhold",82,f5,c1,bc),null(),null(),null());
            					}
            					break;
            					case (int)3: {
HXLINE( 172)						prevNote->animation->play(HX_("redhold",10,1f,bf,bf),null(),null(),null());
            					}
            					break;
            				}
HXLINE( 175)				{
HXLINE( 175)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 175)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.8)) * ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) ))));
            				}
HXLINE( 176)				prevNote->updateHitbox();
            			}
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_183_update)
HXLINE( 184)		this->super::update(elapsed);
HXLINE( 186)		if (this->mustPress) {
HXLINE( 189)			bool _hx_tmp;
HXDLIN( 189)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 189)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * ((Float)0.5))));
            			}
            			else {
HXLINE( 189)				_hx_tmp = false;
            			}
HXDLIN( 189)			if (_hx_tmp) {
HXLINE( 191)				this->canBeHit = true;
            			}
            			else {
HXLINE( 193)				this->canBeHit = false;
            			}
HXLINE( 195)			bool _hx_tmp1;
HXDLIN( 195)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 195)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 195)				_hx_tmp1 = false;
            			}
HXDLIN( 195)			if (_hx_tmp1) {
HXLINE( 196)				this->tooLate = true;
            			}
            		}
            		else {
